...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        this.http = http;
        this.title = 'app';
        this.randomUsersUrl = 'https://randomuser.me/api/?results=500';
    }
    AppComponent.prototype.ngOnInit = function () {
        this.getRandomUsers();
    };
    // Read all REST Items
    AppComponent.prototype.getRandomUsers = function () {
        var _this = this;
        this.randomUsersServiceGetRandomUsers()
            .subscribe(function (randomUsers) {
            _this.randomUsers = randomUsers['results'];
            console.log(_this.randomUsers);
        });
    };
    // Rest Items Service: Read all REST Items
    AppComponent.prototype.randomUsersServiceGetRandomUsers = function () {
        return this.http
            .get(this.randomUsersUrl)
...
module.exports = __webpack_require__(/*! /Users/ashlinnbrennan/DEV/random-person-generator/src/main.ts */"./src/main.ts");
